...
class HDPreprocesser:
    ...
    def process_grid(self, patch_size, dst_res, bin_res=2):
        """
        Generate an image grid based on the tissue position and spot - to - microscope information.
        ...
        Returns:
            None: The generated image grid is stored in the 'image_grid' attribute of the class.
        """
    ...
    def process_tissue(self):
        """
        Generate a tissue grid based on the image grid and tissue position information.

        Returns:
            None: The generated tissue grid is stored in the 'tissue_grid' attribute of the class.
        """
    ...
    def process_all(self, patch_size, dst_res, bin_res=2):
        """
        Perform all data processing steps in sequence.

        This method calls the `process_grid`, `process_image`, and `process_tissue` methods in order.
        ...
        Returns:
            None
        """
        self.process_grid(patch_size, dst_res, bin_res)
        self.process_image()
        self.process_tissue()
